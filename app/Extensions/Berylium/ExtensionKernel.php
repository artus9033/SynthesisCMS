...
class ExtensionKernel extends SynthesisExtension
{
    ...
    public function getDesktopMenuItems($slug)
    {
        ...
        foreach ($items as $item) {
            ...
            if ($mcount) {
                $children_dropdown_btn = "dropdown-button-berylium dropdown-trigger-berylium";
            ...
            $out .= "<li class='$active $children_dropdown_btn' data-target='$children_dropdown_activates'>" . $itemdata['data'] . "</li>";
            if ($mcount) {
