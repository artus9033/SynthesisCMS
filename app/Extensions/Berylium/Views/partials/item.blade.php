<tr>
	...
	<td class="center">
		<p class="center">@if($item->menu != $model->id) <i class="material-icons {{ $synthesiscmsMainColor }}-text">subdirectory_arrow_right</i> @endif{{ App\Toolbox::string_truncate($item->title, 7) }}</p>
		</td>
		<td class="center">
			<p class="center">
