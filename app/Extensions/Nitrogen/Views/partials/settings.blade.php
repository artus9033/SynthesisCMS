	...
	<div class="switch center">
		...
		<div class="col s12">
			...
			<div class="col s12">
				...
				<ul class="collapsible popout col s12 row" data-collapsible="accordion">
					<li>
						<div class="collapsible-header {{ $synthesiscmsMainColor }}-text" id="pagesCollapsible" style="pointer-events: none;"><i class="material-icons {{ $synthesiscmsMainColor }}-text center">pages</i>{{ trans("Nitrogen::nitrogen.assigned_pages") }}</div>
						<div class="collapsible-body col s12 card-panel z-depth-3">
