	...
	<div class="col s12 z-depth-1 lighten-4 row card"
		...
		<div class="card-content">
			...
			<form id="form" class="col s12 row" method="post" action="">
				...
				@include('partials/file-picker', ['picker_modal_id' => 'nitrogen_edit_item_picker', 'callback_function_name' => 'nitrogenImagePickerCallback', 'fileExtensions' => ['jpg', 'png', 'gif', 'jpeg', 'tga', 'gif', 'webp', 'JPG', 'PNG', 'GIF', 'JPEG', 'TGA', 'WEBP']])
				<a href="{{ url()->previous() }}"
