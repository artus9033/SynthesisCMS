...
class ArticleCategoryController extends Controller
{
    ...
    public function editArticleCategoryPost($id, ContentEditorRequest $request)
    {
        ...
        return \Redirect::route('manage_article_categories')->with('messages', array(trans('synthesiscms/admin.msg_article_category_saved', ['name' => Toolbox::string_truncate($articleCategory->title, 15)])));
    }
