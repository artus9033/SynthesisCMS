...
class BackendController extends Controller
{
    ...
    public function feedAdminStatsTrackerCharts(ContentEditorRequest $request)
    {
        ...
        $start = (new DateTime($uniqueVisitsPerTimePeriodChartPeriodStartDateString))->setTime(0, 0, 0);
        $end = (new DateTime($uniqueVisitsPerTimePeriodChartPeriodEndDateString))->setTime(0, 0, 0);
    ...
    public function filePicker(\App\Http\Requests\ContentManagerRequest $request)
    {
