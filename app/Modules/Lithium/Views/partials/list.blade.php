		...
		<div class="card hoverable z-depth-2 center">
			...
			<div class="card-content">
				@if($atom['hasImage'])
					...
					<p class="{{ $synthesiscmsMainColor }}-text" id="artificial-link" style="text-align: left;" onclick="window.location.href='{{ $base_slug }}/atom/{{ $atom['id'] }}'">{{ trans("lithium::lithium.atom_card_link_read") }}</p>
					<style>
