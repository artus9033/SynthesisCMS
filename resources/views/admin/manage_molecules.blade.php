	...
	<div class="col s12 z-depth-1 grey lighten-4 row card" style="display: inline-block; padding: 0px 48px 0px 48px; border: 1px solid #EEE;">
		<div class="card-content">
			...
			<form class="form col s12 row" id="action_form" method="post">
				...
				&nbsp;&nbsp;&nbsp;
				<button type="button" onclick="$('#action_form').attr('action', '/admin/manage_molecules/mass_copy').submit();" class="btn teal white-text hoverable waves-effect waves-light"><i class="material-icons white-text left">content_copy</i>{{ trans('synthesiscms/molecule.copy_selected') }}</button>
				<div class="col s12 row"></div>
