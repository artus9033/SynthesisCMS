	...
	@section('main')
		...
		<div id="modalMassCopy" class="modal">
			<div class="modal-content">
				...
				<div class="col s12">
					<p>
						<input onclick="$('#checkboxMassCopyChildAtomsCheckbox').prop('checked', $(this).prop('checked'));" class="filled-in teal-text" type="checkbox" id="checkboxMassCopyChildAtomsCheckbox" name="checkboxMassCopyChildAtomsCheckbox">
						<label class="teal-text" for="checkboxMassCopyChildAtomsCheckbox">{{ trans('synthesiscms/admin.modal_mass_copy_molecule_checkbox_copy_subatoms') }}</label>
					</p>
				</div>
			</div>
			<div class="modal-footer">
		...
		<div id="modalMassMove" class="modal">
			<div class="modal-content">
				...
				<div class="col s12">
					<p>
						<input onclick="$('#checkboxMassMoveChildAtomsCheckbox').prop('checked', $(this).prop('checked'));" class="filled-in teal-text" type="checkbox" id="checkboxMassMoveChildAtomsCheckbox" name="checkboxMassMoveChildAtomsCheckbox">
						<label class="teal-text" for="checkboxMassMoveChildAtomsCheckbox">{{ trans('synthesiscms/admin.modal_mass_move_molecule_checkbox_move_subatoms') }}</label>
					</p>
				</div>
			</div>
			<div class="modal-footer">
		...
		<div class="col s12 z-depth-1 grey lighten-4 row card" style="display: inline-block; padding: 0px 48px 0px 48px; border: 1px solid #EEE;">
			<div class="card-content">
				<div class="card-title col s12">
					<h3 class="teal-text valign-wrapper"><i class="material-icons prefix teal-text medium valign">group_work</i>&nbsp;{{ trans('synthesiscms/admin.manage_molecules') }}</h3>
				</div>
				...
				<form class="form col s12 row" id="action_form" method="post">
					...
					**/
					...
					<table class="col s12">
						<tbody>
							<tr>
								<td><a href="/admin/manage_molecules/create_molecule" class="col s10 offset-s1 btn teal waves-effect waves-light hoverable"><i class="material-icons white-text left">add</i>{{ trans('synthesiscms/admin.create_molecule') }}</a></td>
								<td><button data-target="modalMassDelete" type="button" class="col s10 offset-s1 btn teal white-text hoverable waves-effect waves-light"><i class="material-icons white-text left">delete_sweep</i>{{ trans('synthesiscms/molecule.delete_selected') }}</button></td>
								<td><button data-target="modalMassCopy" type="button" class="col s10 offset-s1 btn teal white-text hoverable waves-effect waves-light"><i class="material-icons white-text left">content_copy</i>{{ trans('synthesiscms/molecule.copy_selected') }}</button></td>
							</tr>
						</tbody>
					</table>
					<div class="col s12 row"></div>
