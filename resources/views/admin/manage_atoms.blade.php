						...
						<tbody>
								...
								@foreach ($all_atoms as $atom)
										<tr>
											...
											<td class="center"><button data-target="modalDelete{{ $atom->id }}" class="btn teal waves-effect waves-light hoverable"><i class="material-icons white-text left">security</i>{{ trans('synthesiscms/atom.delete_atom') }}</button></td>
										</tr>
								@endforeach
