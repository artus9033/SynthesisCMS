...
<div class="col s12 z-depth-1 grey lighten-4 row card" style="display: inline-block; padding: 0px 48px 0px 48px; border: 1px solid #EEE;">
						...
						<div id="settings-main" class="col s12">
							<div>
								<div class="input-field col s12">
									...
									<input value="{{ $synthesiscmsHeaderTitle }}" id="header_title" name="header_title" type="text">
							...
							<div>
								<div class="input-field col s12">
									...
									<input value="{{ $synthesiscmsTabTitle }}" id="tab_title" name="tab_title" type="text">
						...
						<div id="settings-colors" class="col s12">
							<div>
								<div class="input-field col s10">
									...
									<input value="{{ $synthesiscmsTabColor }}" id="tab_color" name="tab_color" type="text">
									<label for="tab_color">{{ trans('synthesiscms/settings.tab_color') }}</label>
								</div>
								<div class="col s2" style="height: 60px;"><div id="tab_color_probe" style="background-color: {{ $synthesiscmsTabColor }}; width: 100%; height: 100%; box-shadow: 0 4px 5px 0 rgba(0, 0, 0, 0.14), 0 1px 10px 0 rgba(0, 0, 0, 0.12), 0 2px 4px -1px rgba(0, 0, 0, 0.3);"></div></div>
								<div class="input-field col s10 tooltipped" data-position="top" data-delay="50" data-tooltip="{{ trans('synthesiscms/settings.tooltip_main_color') }}">
	...
	<div class="card-action">
		<a onclick="$('#edit').submit()" class="btn-flat waves-effect waves-green {{ $synthesiscmsMainColor }}-text"><i class="material-icons {{ $synthesiscmsMainColor }}-text left">save</i>{{ trans('synthesiscms/admin.save_settings') }}</a>
		<a class="btn-flat waves-effect waves-yellow {{ $synthesiscmsMainColor }}-text" href="{{ URL::previous() }}"><i class="material-icons {{ $synthesiscmsMainColor }}-text left">cancel</i>{{ trans('synthesiscms/admin.cancel_settings') }}</a>
	</div>
</div>
@endsection
