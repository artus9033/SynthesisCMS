				...
				<ul class="collapsible popout col s12 row" data-collapsible="accordion">
					<li>
						...
						<div class="collapsible-body col s12 card-panel z-depth-3">
							...
							@include('partials.file-picker', ['picker_modal_id' => 'article_edit_item_picker', 'callback_function_name' => 'articleImagePickerCallback', 'fileExtensions' => ['jpg', 'png', 'gif', 'jpeg', 'tga', 'gif', 'webp', 'JPG', 'PNG', 'GIF', 'JPEG', 'TGA', 'WEBP']])
