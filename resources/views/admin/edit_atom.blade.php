	...
	<div>
		<div class="card-content">
			...
			<form id="edit" role="form" method="post" action="">
				...
				<script>
				$(document).ready(function(){
					$(".editor").trumbowyg('html', {!! json_encode($atom->description) !!});
				});
				</script>
				...
				<ul class="collapsible popout col s12 row" data-collapsible="accordion">
					<li>
						...
						<div class="collapsible-body col s12 card-panel z-depth-3">
							...
							@include('partials.file-picker', ['picker_modal_id' => 'atom_edit_item_picker', 'callback_function_name' => 'atomImagePickerCallback', 'followIframeParentHeight' => false, 'fileExtensions' => ['jpg', 'png', 'gif', 'jpeg']])
