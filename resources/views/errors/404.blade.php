...
<div class="col s12 row">
 <div class="col s12 m9">
	 <div class="container">
   <h2 class="white-text"><i class="material-icons large prefix center-on-small-only" style="vertical-align: middle;">report_problem</i>&nbsp;{{ trans('synthesiscms/errors.404_header') }}</h2>
 ...
 <div class="col s12 white darken-1 z-depth-3" style="margin-top: 10px;">
      <div class="container" style="margin-top: 40px; margin-bottom: 50px;">
        ...
        <a href="{{ url($synthesiscmsHomePage) }}" class="btn-large waves-effect waves-light">{{ trans('synthesiscms/errors.404_link') }}</a>
      </div>
    </div>
</div>
</div>
