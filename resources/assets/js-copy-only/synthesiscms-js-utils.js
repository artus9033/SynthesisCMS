class SynthesisCmsJsUtils {
  static includeFilePickerDynamically(
    ...
    followIframeParentHeight = false,
    fileExtensions = [
      "jpg",
      "png",
      "gif",
  ...
  static getSynthesisDynamicUrlStartTag() {
    return $('meta[name="synthesiscms-dynamic-url-handler-start-tag"]').attr(
      "content"
    );
  }

  static getSynthesisDynamicUrlEndTag() {
    return $('meta[name="synthesiscms-dynamic-url-handler-end-tag"]').attr(
      "content"
    );
  }
  ...
  static addDynamicSynthesisUrlClientSideProcessableAttributesToElement(
    ...
    element.attr(
      this.getSynthesisDynamicUrlValueTagName(),
      dynamicUrlValueTagValue
    );
    return element;
  }
  ...
  static triggerSynthesisDynamicUrlsRescanOnDocument() {
    console.log(
      "SynthesisCmsJsUtils triggerSynthesisDynamicUrlsRescanOnDocument() invoked"
    );
  ...
  static _substituteSynthesisDynamicUrls(elem) {
    ...
    if (elem instanceof jQuery) {
      ...
      $(elem).each(function(htmlElement) {
        synthesiscmsJsUtilsSelfRef.__substituteSynthesisDynamicUrls(
          $(htmlElement)
        );
      });
    } else {
  ...
  static setLanguage(lang) {
    window.location.href = this.getRealUrlFromDynamicSynthesisUrl(
      "lang/" + lang
    );
  }
}
